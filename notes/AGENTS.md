...
- Write documentation and comments for new function implementations. Define the input arguments and returned arguments clearly.
- Always add comments of the tensor/array shapes in data loaders and training/validation/testing pipelines.
...
- [PROJECT_CONTEXT.md](./docs/PROJECT_CONTEXT.md): Understanding the project, the experimental pipeline and what we are up to now.
